...
/*  Signal handlers                                                          */
/*---------------------------------------------------------------------------*/
static void zw_game_zombie_setup(void) {
    game_active     = true;
    last_wave_score = 0;
    wave_level      = 0;
...
static void zw_game_zombie_run(void) {
...
static void zw_game_zombie_detonator(void) {
    for (uint8_t i = 0; i < NUM_ZOMBIES; i++) {
        if (zombie[i].visible != WHITE) continue;
...
static void zw_game_zombie_reset(void) {
    game_active         = false;
    last_wave_score     = 0;
