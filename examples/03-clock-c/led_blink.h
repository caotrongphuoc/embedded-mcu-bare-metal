...
// RCC — RM0038 §6.3 (extended to APB1ENR for PWR clock)
typedef struct {
...
// PWR — RM0038 §5.4
typedef struct {
	volatile uint32_t CR;  // 0x00: VOS[12:11]
	volatile uint32_t CSR; // 0x04: VOSF[4]
} PWR_TypeDef;

// FLASH access — RM0038 §3.7
typedef struct {
...
#define LED_PIN     8
#define SYSCLK_HZ   32000000U  // HSI 16 MHz × 4 / 2 = 32 MHz
